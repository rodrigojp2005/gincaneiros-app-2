...
<script>
  ...
  {
    const myLatlng = { lat: -30.1014939, lng: -51.2312006 };
  ...
  //  map.setStreetView(panorama);
    ...
    {
      content: "1º Escolha um ponto (clique) no mapa <br> 2º Veja a posição no street view acima <br> 3º Confira o endereço e salve. <br> 4º Agora só comaprtilhar sua gincana",
      position: myLatlng,
    });
